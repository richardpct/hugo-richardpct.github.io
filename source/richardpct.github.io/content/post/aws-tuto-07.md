...
In the [previous tutorial](https://richardpct.github.io/post/2024/04/05/aws-with-opentofu-high-availability-with-auto-scaling-groups/), we made our infrastructure self-healing with Auto Scaling Groups. If the webserver crashed, the ASG replaced it — but there was still a brief downtime while the new instance booted. In production, even a few minutes of downtime is unacceptable.
